...
-- 	CONSTRAINT ID_partyPlayer PRIMARY KEY (id)
-- );
...
-- INSERT INTO playerParty VALUES (1,'adminOk@heig-vd.ch','myparty');
-- INSERT INTO playerParty VALUES (2,'normalOk@heig-vd.ch','myparty');
